...
class ControllerModuleCristaleShippingNotice extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('module/cristale_shipping_notice', 'token=' . $this->session->data['token'], true)
        );

        $data['action'] = $this->url->link('module/cristale_shipping_notice', 'token=' . $this->session->data['token'], true);
        $data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=module', true);
        $data['clear_cache'] = $this->url->link('module/cristale_shipping_notice/clearCache', 'token=' . $this->session->data['token'], true);
  ...
  <file path="catalog/controller/common/footer.php">
    <operation error="skip">
      ...
      <add position="before"><![CDATA[
        $data[\'cristale_shipping_notice\'] = $this->load->controller(\'module/cristale_shipping_notice\');
      ]]></add>
    </operation>
  </file>
  ...
  <file path="catalog/controller/mail/order.php">
    <operation error="skip">
      ...
      <add position="after"><![CDATA[
            $cristale_shipping_notice_email = $this->load->controller(\'module/cristale_shipping_notice/getEmailMessage\');

# Scheduled Popup & Notice Pro 2.0 - OpenCart 4

This is the native OpenCart 4 adapter. It uses extension events for storefront injection and the optional new-order email message. It does not modify OpenCart core files.
...
4. Enable the module, configure at least one campaign, and save.

No OCMOD refresh is required. The first install is disabled and cannot unexpectedly display a live popup.

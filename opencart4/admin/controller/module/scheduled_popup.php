...
class ScheduledPopup extends \Opencart\System\Engine\Controller {
    ...
    protected function validate(array $campaigns, array $language_ids): bool {
        ...
        foreach ($campaigns as $index => $campaign) {
            ...
            if (empty($campaign['devices'])) return $this->campaignError('error_campaign_devices', $number);
    ...
    private function languageData(): array {
        $data = [];
        foreach (['heading_title', 'text_edit', 'text_enabled', 'text_disabled', 'text_signature', 'text_performance_tools', 'text_performance_note', 'button_save', 'button_save_stay', 'button_cancel', 'button_clear_cache'] as $key) $data[$key] = $this->language->get($key);
        return $data;
    }

    private function adminUi(): array {
        $keys = ['text_add_campaign','text_duplicate','text_delete','text_campaign','text_schedule','text_content','text_design','text_targeting','text_statistics','entry_status','entry_campaign_name','entry_priority','entry_timezone','entry_starts_at','entry_ends_at','entry_recurrence','entry_recurrence_until','text_date','text_time_optional','entry_date_format','entry_time_format','text_none','text_weekly','text_monthly','entry_title','entry_message','entry_submessage','entry_thanks','entry_email_enabled','text_email_enabled_help','entry_email_message','entry_button_text','entry_button_url','entry_button_target','entry_countdown','entry_countdown_label','entry_image','text_remove_image','entry_preset','text_preset_elegant','text_preset_minimal','text_preset_bold','entry_accent_color','entry_background_color','entry_text_color','entry_button_color','entry_overlay_color','entry_overlay_opacity','entry_blur','entry_target_type','text_target_all','text_target_categories','text_target_products','entry_devices','text_device_desktop','text_device_tablet','text_device_mobile','text_device_help','text_device_laptop','text_responsive_studio','text_responsive_help','entry_popup_width','entry_popup_height','entry_breakpoint_mobile','entry_breakpoint_tablet','entry_breakpoint_laptop','entry_categories','entry_products','placeholder_product_search','text_impressions','text_clicks','text_closes','text_ctr','text_reset_stats','text_preview','text_shortcodes','text_shortcode_help','text_upload_help','text_no_campaigns','text_confirm_delete','text_new_campaign','text_open_same','text_open_new','text_apply_romanian_template','text_apply_english_template','text_template_help','text_product_loading','text_product_empty','text_product_error','text_product_suggestions','text_product_model','button_product_search'];
        $ui = [];
